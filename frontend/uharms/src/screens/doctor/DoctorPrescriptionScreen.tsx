...
const DoctorPatientDetailScreen = ({ route, navigation }: Props) => {
  ...
  const handleMessagePatient = () => {
    ...
    // You'll need to find the conversation or create one
    Alert.alert('Coming Soon', 'Direct messaging from patient detail');
  };
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleMessagePatient} style={styles.messageButton}>
      ...
      {patient.recentAppointments && patient.recentAppointments.length > 0 && (
        <View style={styles.infoCard}>
          ...
          {patient.recentAppointments.slice(0, 3).map((apt, index) => (
            <View key={index} style={styles.appointmentItem}>
              <View style={styles.appointmentDate}>
                <Icon name="calendar" size={14} color="#16a34a" />
      ...
      <TouchableOpacity style={styles.historyButton} onPress={() => Alert.alert('Coming Soon', 'Full medical history coming soon')}>
